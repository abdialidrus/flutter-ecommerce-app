import 'package:flutter_ecommerce_app/data/repositories/product/product_repository.dart';
...
class ProductController extends GetxController {
  ...
  Future<void> uploadDummyProducts() async {
    try {
      final dummyProducts = TDummyData.products;
      await productRepository.uploadDummyData(dummyProducts);
    } catch (e) {}
  }
}
