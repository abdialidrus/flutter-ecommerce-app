...
class TFirebaseException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'keychain-error':
        return 'A keychain error occured. Please check keychain and try again.';
      case 'internal-error':
        return 'An internal authentication error occured. Please try again later.';
      case 'invalid-app-credential':
        return 'the app credential is invalid. Contact support for assistance.';
      case 'user-mismatch':
      ...
      case 'uid-already-exists':
        return 'The provided user UID is already in use by another user.';
      ...
      case 'invalid-sender':
        return 'The email template sender is invalid. Please verifi the sender\'s email.';
